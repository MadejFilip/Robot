...
public class Main {
	...
	public static void main(final String... args) {
		...
		final TrayIcon trayIcon = new TrayIcon(Toolkit.getDefaultToolkit().getImage("/home/kj/icon.png"),
		...
		// if(RUN_COUNTER <7 && hourFormat.format(curDate).equals("05") &&
		// !LAST_DATE.equals(dateFormat.format(curDate))){
		// downloading();
